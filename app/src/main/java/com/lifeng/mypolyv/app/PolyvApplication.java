package com.lifeng.mypolyv.app;
...
//		new LoadConfigTask().execute();
        ...
        //使用SDK加密串来配置
        client.setConfig("4Bt7VTPF/NXx8PbSnehIa0pRs4sbdKD/caYXExXSp/CPCQybNWRym7BjJcRGMPk6y0BP/pcaZttmmx/fM9EGfF0+JwMXNs+zBoQpxkmYxaDTd5W27Z3G/rMfFs8KYay5YP5zoN+AxUJA/7n5H6Qyog==", aeskey, iv, getApplicationContext());
        //初始化SDK设置
